...
final class RichInt private[synth](val i: Int)
  extends AnyVal with RichNumber.UnaryFloatOps with RichNumber.NAryFloatOps
...
final class RichFloat private[synth](val f: Float)
  extends AnyVal with RichNumber.UnaryFloatOps
  with RichNumber.NAryFloatOps with RichNumber.NAryDoubleOps with RichNumber.NAryGEOps {
...
final class RichDouble private[synth](val d: Double)
  extends AnyVal with RichNumber.NAryDoubleOps with RichNumber.NAryGEOps {
